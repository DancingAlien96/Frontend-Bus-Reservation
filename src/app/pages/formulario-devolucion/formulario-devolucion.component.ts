...
export class FormularioDevolucionComponent {
	...
	loadFormSubmit() {
		...
		this.formSubmit = this.fb.group({
			...
			kilometrajeEntrega: [this.fecv.KILOMETRAJE, [Validators.required, Validators.min(0), Validators.max(100000000)]],
			...
			kilometrajeFinal: [this.fecv.KILOMETRAJE, [Validators.required, Validators.min(0), Validators.max(100000000)]],
